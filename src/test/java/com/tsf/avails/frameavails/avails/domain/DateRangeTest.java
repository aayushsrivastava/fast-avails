...
class DateRangeTest {
    ...
    @BeforeEach
    void setUp() {
        this.lastDataRefreshDate = "01022022";
    }

    @Test
    void shouldCalculateIndexForStartDateAsAvailStartDate() {
        this.dateRange = new DateRange("01022022", "01032022", lastDataRefreshDate);
    ...
    void shouldCalculateIndexForStartDateOneWeekAwayFromAvailsStartDate() {
        this.dateRange = new DateRange("08022022", "01032022", lastDataRefreshDate);
    ...
    void shouldCalculateIndexForStartDateTwoAndHalfWeeksFromStartDate() {
        this.dateRange = new DateRange("18022022", "01032022", lastDataRefreshDate);
    ...
    void shouldCalculateIndexForDigitalStartDateOneDayFromAvailsStartDate() {
        this.dateRange = new DateRange("02022022", "01032022", lastDataRefreshDate);
    ...
    void shouldCalculateIndexForDigitalEndDateOneDayFromAvailsStartDate() {
        this.dateRange = new DateRange("01022022", "02022022", lastDataRefreshDate);
